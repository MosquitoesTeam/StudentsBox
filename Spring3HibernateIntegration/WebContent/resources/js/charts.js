jQuery(document).ready(function() {
    ...
    var piedata = [
        ...
        { label: "Series 4", data: [[1,70]], color: '#41868f'},
   ...
   var m1 = new Morris.Line({
    ...
    var m6 = new Morris.Donut({
        ...
        colors: ['#D9534F','#1CAF9A','#41868f','#5BC0DE','#41868f']
    });
    ...
    jQuery('#sparkline3').sparkline([4,3,3,1,4,3,2,2,3], {
		  type: 'pie', 
		  height:'33px',
        sliceColors: ['#F0AD4E','#41868f','#D9534F','#1CAF9A','#5BC0DE']
    });
